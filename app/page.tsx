    ...
    <main className="z-1 flex min-h-screen w-full flex-col items-center justify-center py-32">
      ...
      <StickyHeader title={"Robin Mofakham"} />
        ...
        <p className="italic text-lg font-semibold text-slate-400">
          ...
          {"//"}<span className="mx-4">Leadership</span>
        ...
        <ul className="about-list text-slate-600">
          ...
          <li>I like talking about the "What", and I resonate with those who are interested in the "How" - joining this up in a cohesive way is what I really enjoy.</li>
        ...
        <ul className="about-list text-slate-200">
          ...
          <li>Reduced average project cost overruns from 100% to 10% by improved governance</li>
        </ul>
        <div className="min-h-12 flex my-16 justify-between text-slate-200">
          <div className="w-3/12 border-2"></div>
          <div className="w-3/12 border-2"></div>
          <div className="w-3/12 border-2"></div>
        </div>
